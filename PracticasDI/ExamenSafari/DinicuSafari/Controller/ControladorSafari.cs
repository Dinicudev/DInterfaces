...
namespace DinicuSafari.Controller
{
    ...
    public class ControladorSafari
    {
        ...
        public bool EsNoche => safari.EsNoche;
        ...
        private void LlenarSafariConSeres()
        {
            ...
            int totalPlantas = (int)(totalEspacios * 0.5);  // 60% plantas.
            int totalHerviboros = (int)(totalEspacios * 0.3);  // 30% herbívoros.
            int totalElefantes = (int)(totalEspacios * 0.1);//Examen1
            int totalCarnivoros = totalEspacios - totalPlantas - totalHerviboros - totalElefantes;//EXamne1
            ...
            for (int i = 0; i < totalElefantes; i++)//Examen1
            {
                GenerarPosicion();
                safari.AgregarSer(new Elefante($"Elefante{i + 1}", x, y, safari));
            }
        ...
        // Nuevo método  10 pasos.Examen2
        public void Ejecutar10Pasos()
        {
            if (form.InvokeRequired)
            {
                form.Invoke(new Action(() => Ejecutar10Pasos()));
                return;
            }

            safari.Ejecutar10Turnos(); // Ejecuta 10 turnos en el modelo.
    ...
    private void VerificarGameOver() //Examen4
        {
            ...
            if (herviboros == 0 && carnivoros == 0 && plantas == 100)
            {
                mensaje = "Solo las plantas pueden dominar el mundo.";
            }

            // Condición 2: Todos los seres han muerto.
            if (herviboros == 0 && carnivoros == 0 && plantas == 0)
            {
                mensaje = "Es el Fin del Mundo.";
            }
