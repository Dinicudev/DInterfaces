...
namespace DinicuSafari
{
    public partial class FormSafari : Form
    {
                ...
                for (int j = 0; j < tableLayoutPanel1.ColumnCount; j++)
                {
                    ...
                    if (label != null)
                    {
                        ...
                        switch (celda)
                        {
                            ...
                            case "Herviboro":
                                label.Text = "Gacela"; // Mostramos "Gacela" para los herbívoros.
                                label.BackColor = Color.Brown; // Color marrón para herbívoros.
                                break;
        ...
        {
            IniciarAutoplay(); // Inicia el autoplay desde el menú.
        }
